...
/*   Updated: 2015/01/18 18:47:28 by dsousa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool			GKrellMProgram::init()
{
	...
	ModuleObject *memoryModule = new ModuleObject( "Memory", Vector2f( 98, 18 ), Vector2f( 30, 7 ) );
	...
	ModuleObject *memoryGraphicModule = new ModuleObject( "Memory Graphic", Vector2f( 60, 13 ), Vector2f( 75, 7 ) );
